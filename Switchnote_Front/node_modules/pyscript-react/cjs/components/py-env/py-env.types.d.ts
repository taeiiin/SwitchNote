...
export type PyEnvProperties<OptionalProperties> = OptionalProperties extends infer OptionalProperties ? OptionalProperties & PyEnvPropertiesBase : PyEnvPropertiesBase;
export type PyEnvTag = {
    <OptionalProperties extends object>(properties: PyEnvProperties<OptionalProperties>, reference?: ForwardedRef<HTMLElement>): JSX.Element;
    displayName?: string;
