...
export type PyScriptProviderPropertiesWithoutCSSPropertiesFullname = {
    cssProps?: Omit<DetailedHTMLProps<LinkHTMLAttributes<HTMLLinkElement>, HTMLLinkElement>, "href">;
    cssProperties?: never;
};
export type PyScriptProviderPropertiesWithCSSPropertiesFullname = {
    cssProps?: never;
    cssProperties?: Omit<DetailedHTMLProps<LinkHTMLAttributes<HTMLLinkElement>, HTMLLinkElement>, "href">;
};
export type PyScriptProviderPropertiesWithJSPropertiesFullname = {
    jsProps?: never;
    jsProperties?: Omit<DetailedHTMLProps<ScriptHTMLAttributes<HTMLScriptElement>, HTMLScriptElement>, "src">;
};
export type PyScriptProviderPropertiesWithoutJSPropertiesFullname = {
    jsProps?: Omit<DetailedHTMLProps<ScriptHTMLAttributes<HTMLScriptElement>, HTMLScriptElement>, "src">;
    jsProperties?: never;
};
...
export type PyScriptProviderProperties = PropsWithChildren<PyScriptProviderPropertiesBase & (PyScriptProviderPropertiesWithCSSSourceFullname | PyScriptProviderPropertiesWithoutCSSSourceFullname) & (PyScriptProviderPropertiesWithJSourceFullname | PyScriptProviderPropertiesWithoutJSourceFullname) & (PyScriptProviderPropertiesWithCSSPropertiesFullname | PyScriptProviderPropertiesWithoutCSSPropertiesFullname) & (PyScriptProviderPropertiesWithJSPropertiesFullname | PyScriptProviderPropertiesWithoutJSPropertiesFullname) & (PyScriptProviderPropertiesWithHelmetPropertiesFullname | PyScriptProviderPropertiesWithoutHelmetPropertiesFullname) & (PyScriptProviderPropertiesWithHelmetProviderPropertiesFullname | PyScriptProviderPropertiesWithoutHelmetProviderPropertiesFullname)>;
